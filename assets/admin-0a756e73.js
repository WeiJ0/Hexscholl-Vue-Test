import{c as r,i as l,g as h,d as m,a as f}from"./API-cbbf5697.js";import{s as c,a as w,b as u}from"./Notify-514eff47.js";const g=!0;let b={info:[],getViews:async function(){let{isSuccess:i,message:e,views:t}=await h(g);i?(this.info=t,await this.render()):c(e)},render:function(){const i=document.querySelector("#spanCnt");i.textContent=this.info.length;const e=document.querySelector("#viewTable > tbody");let t="";this.info.forEach(d=>{const{id:s,name:n,content:a,image:o}=d;t+=`
            <tr>
                <td>
